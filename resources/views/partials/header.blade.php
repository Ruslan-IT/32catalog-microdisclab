                ...
                <div class="header__topbar4--contact__info">
                    <ul class="header__topbar4--contact__info--flex d-flex">
                        ...
                        <li class="header__topbar4--contact__info--list">
                            ...
                            <a href="mailto:info@edukingmail.com"> {{ $siteSettings->email }}</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="main__logo">
                    <h1>
                        <a class="main__logo--link" href="/">
                            <img style="width: 140px;" class="main__logo--img" src="/assets/img/logo/nav-log-2.png" alt="logo-img">
                        </a>
                    </h1>
                </div>
        ...
        <div class="offcanvas__inner">
            <div class="offcanvas__logo">
                <a class="offcanvas__logo_link" href="/">
                    <img src="assets/img/logo/nav-log-2.png" alt="Grocee Logo" width="158" height="36">
                </a>
            ...
            <nav class="offcanvas__menu">
                <ul class="offcanvas__menu_ul">
                    ...
                    <li class="offcanvas__menu_li">
                        <a class="offcanvas__menu_item" href="{{ route('category.index') }}">
                            Shop
                        </a>
                        ...
                        <ul class="offcanvas__sub_menu">
                            @foreach($categories as $category)
                                <li class="offcanvas__sub_menu_li">
                                    <a href="{{ route('category.show', $category->slug) }}" class="offcanvas__sub_menu_item">
                                        {{ $category->name }}
                                    </a>
                                    ...
                                    @if($category->children->count())
                                        <ul class="offcanvas__sub_menu">
                                            @foreach($category->children as $child)
                                                <li class="offcanvas__sub_menu_li">
                                                    <a href="{{ route('category.show', $child->slug) }}" class="offcanvas__sub_menu_item">
                                                        {{ $child->name }}
                                                    </a>
                                                </li>
                                            @endforeach
